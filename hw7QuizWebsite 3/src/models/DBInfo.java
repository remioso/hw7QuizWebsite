...
public class DBInfo {
	...
	public static final String MYSQL_USERNAME = "ccs108remioso";
	public static final String MYSQL_PASSWORD = "5Rj98kSfjh268S3v";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = " c_cs108_remioso";
